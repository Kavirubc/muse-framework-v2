<html>
 <head>
  ...
  <link href="./public/assets/css/childuser/childcrechapters.css" rel="stylesheet"/>
   </head>
 <body>
 <?php include 'header.php'; ?>
  <div class="container">
   <img alt="Hello'" class="header-image"  src="https://img.freepik.com/free-photo/childhood-young-boy-home_144627-39933.jpg" />
   <h1>
    Welcome to Your Creative Story Writing!
   </h1>
   <p>
